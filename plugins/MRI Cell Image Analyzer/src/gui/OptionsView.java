...
/**
 * A view of the options of an operation. An operation can
 * have any combinations of options. The options are displayed
...
public class OptionsView extends javax.swing.JFrame {
	...
	protected Options model;  //  @jve:decl-index=0:
