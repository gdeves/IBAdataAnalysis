...
/**
 * The operation detects regions that connect objects. This is done by calculating the difference of the 
 * input image and the result of the close operation.
 * 
 * @author Volker Bäcker
 */
public class BottomHatGrayOperation extends MorphologyBaseOperation {
	...
	public void runFilter() {
		...
		CloseGrayOperation operation = new CloseGrayOperation();
