...
public class FindSkeletonBranchingPointsOperation extends Operation {
/**
	 * 
	 */
	private static final long serialVersionUID = -2294375489057895153L;
	...
	public void doIt() {
		...
		tracer.run();
		resultPoints = tracer.getBranchingPoints();
	}
