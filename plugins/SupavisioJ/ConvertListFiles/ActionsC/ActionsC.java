package SupavisioJ.ConvertListFiles.ActionsC;
...
import SupavisioJ.ConvertListFiles.listFiles.listFiles;
import SupavisioJ.Prefs.Prefs;
...
/** Management class
 * This class is used to launch data treatment from outside other classes
 * An object of this class is caracterized by : 
 * @param listFilesArray  an array containing paths for all files to be read (unsorted)
 * @param flags   an array containing values of buttons & checkbox in user interface FrameC
 * @param pixe_stack  a table containing a stack of pixe spectras used for summing multiple detectors spectra
 * @param stimStack  an image stack containing all STIM map calculated at once during data treatment
 */
...
public class ActionsC{
  ...
  ArrayList <double []> pixe_stack=new ArrayList <double[]>();
