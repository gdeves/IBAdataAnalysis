...
import static IBA_J.MainFrame.MainFrame.tr;
...
public class ActionsC{
          ...
          try{
                  ...
                  File [] selectedFiles = jF.getSelectedFiles(); 
                          for (File f : selectedFiles){
                                  ...
                                  prefs.ijPrefsSaveDirectory(f.getAbsolutePath());
                          }
  ...
  */
  private void processSTIM(ADC adc, listFiles lF, int indexOfADC){
      ...
      if (flags[21]==1) adc.saveMedianImage(lF.setExtension("medMap.tiff")); //saving map
      ...
      if (flags[22]==1){
          Spectra spectraXYE= new Spectra(adc,lF.getPath());
          File f=new File(lF.getPath());
          spectraXYE.plotSpectra("STIM / "+" ADC: "+String.valueOf(indexOfADC+1), (String) tr("File: ")+f.getName(),3).showVisible();
      }     
      java.lang.System.gc();
  }
  /**
  ...
  */
  ...
  public void generateMaps(Spectra drawSpectra, Vector limits){
      // generates images for all  selected checkbox
        ...
        try {
            ...
            ArrayList<String> nameOfImgGen = (ArrayList<String>) limits.get(0);
            ArrayList<float[]> minMaxSpectra = (ArrayList<float[]>) limits.get(1);
